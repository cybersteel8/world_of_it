			...
			<div class="quoteFormSection">
				<table>
					...
					<tr>
						...
						<td class="tableInput"><input type="text" id="quoteFName" name="quoteFName" size="20" maxlength="128" value="<?php echo (isset($quoteFName) ? $quoteFName : ''); ?>" onblur="validateRequired(name)"></td>
					...
					<tr>
						...
						<td class="tableInput"><input type="text" id="quoteLName" name="quoteLName" size="20" maxlength="128" value="<?php echo (isset($quoteLName) ? $quoteLName : ''); ?>" onblur="validateRequired(name)"></td>
					...
					<tr>
						...
						<td class="tableInput"><input type="email" id="quoteEmail" name="quoteEmail" size="20" maxlength="256" value="<?php echo (isset($quoteEmail) ? $quoteEmail : ''); ?>" onblur="validateEmail(value)"></td>
						<td><span id="quoteEmailError" style="display: none;">You must enter a valid email address</span></td>
					</tr>
					<tr>
						<td class="tableLabel"><label for="quotePhone">Contact Number</label></td>
						<td class="tableInput"><input type="text" id="quotePhone" name="quotePhone" size="20" maxlength="128" value="<?php echo (isset($newsletterEmail) ? $newsletterEmail : ''); ?>" onblur="validatePhone(name)"></td>
						<td><span id="quotePhoneError" style="display: none;">You must enter a valid phone number</span></td>
					</tr>
				</table>
			</div>
			<div class="quoteFormSection">
				<table>
					...
					<tr>
						...
						<td class="tableInput"><input type="text" id="quoteFName" name="quoteFName" size="20" maxlength="128" value="<?php echo (isset($quoteFName) ? $quoteFName : ''); ?>"></td>
					</tr>
					<tr>
						<td class="tableLabel"><label for="quoteLName">What's your business name?</label></td>
						<td class="tableInput"><input type="text" id="quoteLName" name="quoteLName" size="20" maxlength="128" value="<?php echo (isset($quoteLName) ? $quoteLName : ''); ?>"></td>
					</tr>
					<tr>
						<td class="tableLabel"><label for="quoteEmail">Current website (If you have one)</label></td>
						<td class="tableInput"><input type="email" id="quoteEmail" name="quoteEmail" size="20" maxlength="256" value="<?php echo (isset($quoteEmail) ? $quoteEmail : ''); ?>"></td>
					</tr>
					<tr>
